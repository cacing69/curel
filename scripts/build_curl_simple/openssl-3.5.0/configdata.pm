...
our %config = (
    ...
    "perlargv" => [
        "android-x86_64",
        "-D__ANDROID_API__=24",
        "--prefix=/Users/ibnulmutaki/Development/github/curel/scripts/build_curl_simple/out/x86_64",
        "no-shared",
        "no-tests"
    ],
    "perlenv" => {
...
unless (caller) {
    ...
    use lib '/Users/ibnulmutaki/Development/github/curel/scripts/build_curl_simple/openssl-3.5.0/util/perl';
    use OpenSSL::fallback '/Users/ibnulmutaki/Development/github/curel/scripts/build_curl_simple/openssl-3.5.0/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/ibnulmutaki/Development/github/curel/scripts/build_curl_simple/openssl-3.5.0/Configurations';
        use gentemplate;
